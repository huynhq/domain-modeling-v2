...
class FamilyTests : XCTestCase {
    ...
    func testCustomStringConvertible() {
        let phil = Person(firstName: "Phil", lastName: "Dunphy", age: 40)
        
        let claire = Person(firstName: "Claire", lastName: "Dunphy", age: 37)
        
        let family = Family(spouse1: phil, spouse2: claire)
        
        // need to complete this
        XCTAssert(family.description == "Phil Dunphy;Claire Dunphy;")
    }
